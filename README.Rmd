...
In this short tutorial we will build an R package, write unit tests for it, 
push it in a GitHub repository and integrate Travis CI with it.
<!-- Build  a drat repository to host  -->
